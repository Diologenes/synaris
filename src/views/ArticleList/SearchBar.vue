	...
	<div class="c-panel-filter">
		<div class="c-panel-filter__wrap">
			<input
				...
				@keyup.esc="restore"
				@keyup="submit"
				:class="{ 'c-panel-filter__input--is-active': isFilter }"
				class="c-panel-filter__input"
				type="text"
				placeholder="Filter articles ..."
			/>
			<div :class="{ 'c-panel-filter__close--is-active': isFilter }" class="c-panel-filter__close">
				<button tabindex="-1" @click="restore" class="u-icon--close"></button>
			</div>
		</div>
